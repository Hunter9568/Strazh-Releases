...
[⬇️ Скачать «Страж» 0.10.2 для Mac — DMG](https://github.com/Hunter9568/Strazh-Releases/releases/download/v0.10.2/Strazh-0.10.2-arm64.dmg)
...
> [!IMPORTANT]
> Для установки скачивайте только файл **`Strazh-0.10.2-arm64.dmg`** по большой
...
Версия 0.10.2 предназначена только для macOS на Apple Silicon. Windows, Linux и
...
1. Нажмите [**скачать Strazh-0.10.2-arm64.dmg**](https://github.com/Hunter9568/Strazh-Releases/releases/download/v0.10.2/Strazh-0.10.2-arm64.dmg).
2. Дождитесь загрузки файла размером около 612 МБ.
...
```bash
shasum -a 256 "$HOME/Downloads/Strazh-0.10.2-arm64.dmg"
```
...
Версия 0.10.2 — тестовая сборка для ограниченного распространения. Перед
