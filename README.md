...
| ☁️ | **Облачный AI** | OpenAI, DeepSeek, Gemini, Anthropic Claude, VseLLM, OpenRouter, Groq, Mistral, Together AI и сторонние OpenAI-совместимые API |
...
|---|---:|---|---|
| **Локальная модель** | Нет | На вашем Mac | Скачать совместимую модель |
...
- локальные AI-модели не требуют отправки запроса облачному провайдеру;
